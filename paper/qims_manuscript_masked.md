...
produced by the scripts named in section 5,
and is reproducible from the accompanying repository and the public VerSe
release.*
...
|---|---|---|---|---|---|---|---|---|
| half-separation (mm) | 16.6 | 11.9 | 13.3 | 14.1 | 11.8 | 13.1 | 16.2 | 19.7 |
| posterior offset (mm) | 18.4 | 24.0 | 27.2 | 27.5 | 27.6 | 29.1 | 29.7 | 25.6 |

The posterior offset carries the rotation signal and runs from 18 mm at T1 to about 30 mm in the lumbar spine, so one degree of rotation displaces the
projected midpoint by 0.32–0.52 mm. The table is regenerated by
...
repository
[repository URL withheld for double-anonymised review; given on the title page],
[archive DOI withheld for double-anonymised review; given on the title page], over the public VerSe release. Every figure
...
*Reporting Checklist:* No EQUATOR reporting guideline was identified that
covers a study of this kind, which characterises a measurement layer rather
than a diagnostic test, a trial or an observational cohort. The editorial
office's guidance is sought in the cover letter, and any checklist it
nominates will be completed.
...
the title page and are withheld here for double-anonymised review. Five
